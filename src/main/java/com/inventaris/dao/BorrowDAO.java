...
public class BorrowDAO {
    ...
    public boolean create(Borrow borrow) {
        String sql = "INSERT INTO borrow (id_peminjam, kode_barang, jumlah_pinjam, " +
                     "tgl_peminjaman, tgl_pinjam, dl_kembali, status_barang, status_approval) " +
                     "VALUES (?, ?, ?, ?, ?, ?, 'pending', 'pending_instansi')";
        ...
        try (Connection conn = dbConfig.getConnection();
            ...
            if (inserted) {
                System.out.println("✅ Pengajuan berhasil dibuat (pending approval)");
            }
...
public boolean rejectByInstansi(int borrowId, String alasan, Integer instansiId) {
    ...
    private Borrow extractBorrowFromResultSet(ResultSet rs) throws SQLException {
        ...
        borrow.setNamaInstansi(rs.getString("nama_instansi"));
    ...
    // ============================================================
    // HELPER METHOD (sudah ada sebelumnya)
    // ============================================================
    
   // ================================================================
// INSTRUKSI PENTING:
// 1. JANGAN COPY SELURUH FILE INI!
// 2. HANYA TAMBAHKAN 2 METHOD DI BAWAH INI KE FILE ANDA
// 3. TEMPATKAN DI AKHIR CLASS, SEBELUM KURUNG TUTUP }
// ================================================================
    ...
    /**
     * Get statistik peminjaman per instansi (untuk dashboard)
     * Menghitung SEMUA riwayat peminjaman (termasuk pending, ditolak, approved, selesai)
     * Return: Map<Integer, Map<String, Integer>>
     * Format: {id_instansi: {nama_barang: total_peminjaman}}
     */
...
// ================================================================
// AKHIR METHOD YANG DITAMBAHKAN
// Pastikan masih ada kurung tutup } class di bawah ini!
// ================================================================
